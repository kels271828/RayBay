...
doses = np.arange(1600, 2001.0, 100.0)
...
for ii in range(len(doses)):
    ...
    # Save results
    np.save(fpath + 'doses_5_26_2.npy', doses)
    np.save(fpath + 'volumes_5_26_2.npy', volumes)
    np.save(fpath + 'oar_avg_5_26_2.npy', oar_avg)
    np.save(fpath + 'ptv_max_5_26_2.npy', ptv_max)
    np.save(fpath + 'ptv_d95_5_26_2.npy', ptv_d95)
    np.save(fpath + 'dvh_doses_5_26_2.npy', dvh_doses)
    np.save(fpath + 'dvh_oar_5_26_2.npy', dvh_oar)
    np.save(fpath + 'dvh_ptv_5_26_2.npy', dvh_ptv)
    np.save(fpath + 'oar_avg_norm_5_26_2.npy', oar_avg_norm)
    np.save(fpath + 'ptv_max_norm_5_26_2.npy', ptv_max_norm)
    np.save(fpath + 'ptv_d95_norm_5_26_2.npy', ptv_d95_norm)
    np.save(fpath + 'dvh_doses_norm_5_26_2.npy', dvh_doses_norm)
    np.save(fpath + 'dvh_oar_norm_5_26_2.npy', dvh_oar_norm)
    np.save(fpath + 'dvh_ptv_norm_5_26_2.npy', dvh_ptv_norm)
